...
/*
 * The 1st function below returns true if a number is divisible by 3 and  
 * false if it is not, using the modulo (%) operator.
 *
 * The 2nd function below returns true if a number is divisible by 3 or 5
